	...
	<header class="sticky top-0 z-50 w-full border-b border-gray-800 bg-gray-950">
		<div class="container flex h-14 items-center justify-between">
			...
			<div class="flex items-center gap-4">
				...
				<Button variant="outline" href="/pyrkon" class="border-purple-700 bg-purple-700 text-purple-100 hover:bg-purple-800 hover:text-purple-200">🎵 Admin</Button>
				<Button variant="outline" href="/screens" class="border-blue-700 bg-blue-700 text-blue-100 hover:bg-blue-800 hover:text-blue-200">🖼️ Screens</Button>
